...
namespace DemoApp.Behaviors
{
    public class EventToCommandBehavior : BindableBehavior<View>
    {
        ...
        public static BindableProperty SenderConverterProperty =
            BindableProperty.CreateAttached("SenderConverter", typeof(IValueConverter), typeof(EventToCommandBehavior), null,
                BindingMode.OneWay);

        public static BindableProperty EventParameterConverterProperty =
            BindableProperty.CreateAttached("EventParameterConverter", typeof(IValueConverter), typeof(EventToCommandBehavior), null,
                BindingMode.OneWay);
        ...
        public IValueConverter SenderConverter
        {
            get { return (IValueConverter)GetValue(SenderConverterProperty); }
            set { SetValue(SenderConverterProperty, value); }
        }
        ...
        private void OnFired(object sender, EventArgs eventArgs)
        {
            ...
            if (sender != null && eventArgs != null)
                parameter = EventParameterConverter.Convert(eventArgs, typeof(object), sender, CultureInfo.CurrentUICulture);
